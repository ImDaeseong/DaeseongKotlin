...
class AdView3Activity : AppCompatActivity() {

    private val tag: String = AdView3Activity::class.java.simpleName
    ...
    private fun initrewardedAd() {
        ...
        rewardedAd = RewardedAd(this, "ca-app-pub-3940256099942544/8691691433")
