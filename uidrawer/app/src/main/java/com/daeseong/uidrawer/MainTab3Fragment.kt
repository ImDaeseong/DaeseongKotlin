...
class MainTab3Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, @Nullable savedInstanceState: Bundle?) {
        ...
        wvWebView = view.findViewById<WebView>(R.id.webview)
        pProgressBar = view.findViewById<ProgressBar>(R.id.progressbar1)
        swipeRefreshLayout = view.findViewById<SwipeRefreshLayout>(R.id.swLayout)
        swipeRefreshLayout!!.setColorSchemeColors(resources.getColor(R.color.refresh_progress_3), resources.getColor(R.color.refresh_progress_2), resources.getColor(R.color.refresh_progress_3) )
        swipeRefreshLayout!!.setOnRefreshListener {

            try {
                Log.e(tag, "onRefresh")
                bRefresh = true
                wvWebView!!.loadUrl(wvWebView!!.url)
            } catch (e: Exception) {
                e.printStackTrace()
            }
        }
    ...
    inner class webJavaScriptInterface internal constructor(context: Context) {
